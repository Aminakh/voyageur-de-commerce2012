...
{	
	...
	public   ArrayList<Integer> calculAlgoComplet(int v, ArrayList<Integer> k, ArrayList<Integer> l, int [][] ville){
		if (l.size() == 0){
			k.set(0, ville[v][k.get(1)] + k.get(0));
			k.add(k.get(1));
			System.out.println(k);
			if(k.get(0) < this.meilleurtrajet.get(0)){this.meilleurtrajet = k;}
			}
		else{
